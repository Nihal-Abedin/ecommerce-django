# Generated by Django 5.0.1 on 2024-01-09 22:32
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('gid', shortuuid.django_fields.ShortUUIDField(alphabet='123456789bcdefg', length=10, max_length=10, prefix='', unique=True)),
                ('product', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='store.products')),
            ],
        ),
        migrations.CreateModel(
